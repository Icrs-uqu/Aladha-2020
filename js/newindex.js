...
window.addEventListener('load', DrawPlaceholder(img,ctx,"#756134",'p3.jpg',490,280));
...
window.addEventListener('load', DrawPlaceholder(img1,ctx1,"#fff",'p22.jpg',150,450));
...
window.addEventListener('load', DrawPlaceholder(img2,ctx2,"#fff",'p1.jpg',370,500));
...
img3.crossOrigin="anonymous";
    ...
    window.addEventListener('load', DrawPlaceholder(img3,ctx3,"#fff",'p4.jpg',350,40));
...
window.addEventListener('load', DrawPlaceholder(img4,ctx4,"#AC8F4B",'p5.jpg',360,530));
